...
#ifndef ENCODEDETECT_H
#define ENCODEDETECT_H

#include "Encode.h"

int EncodeDetectFile(const char*, int);
int EncodeDetect(char*, int);
int IsUtf8(unsigned char*);
int IsSjis(unsigned char*);
int IsEucJp(unsigned char*);
int CompCharHex(unsigned char*, unsigned long);
